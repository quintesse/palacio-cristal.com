...
<div class="subpage">
	...
	<div class="text">
		<table id="contents_menu" class="menu" cellspacing="0">
			...
			<tr id="products_submenu" class="submenu">
				<td nowrap><table class="submenu" cellspacing="0">
				<tr id="eaccent" parentmenu="products">
					<td nowrap class="spacer"></td>
					<td nowrap><a href="/products/eaccent/">Easy Accent</a></td>
				</tr>
				<tr id="deeenes" parentmenu="products">
					<td nowrap class="spacer"></td>
					<td nowrap><a href="/products/DeeEnEs/">DeeEnEs</a></td>
				</tr>
				</table></td>
			</tr>
			<tr id="projects">
				<td nowrap><a href="/projects/">Current Projects</a></td>
			</tr>
			<tr id="projects_submenu" class="submenu">
				<td nowrap><table class="submenu" cellspacing="0">
				<tr id="lcdproc" parentmenu="projects">
					<td nowrap class="spacer"></td>
					<td nowrap><a href="/projects/lcdproc/">lcdproc</a></td>
				</tr>
				</table></td>
			</tr>
			<tr id="toi">
